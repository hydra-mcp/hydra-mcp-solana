...
export const getDefaultAppPosition = () => {
    // Position apps in the center of the screen by default
    return {
        x: (globalThis.window.innerWidth - 800) / 2,
        y: (globalThis.window.innerHeight - 600) / 2
    };
};
...
export const createAppWindow = (appId: string) => {
    ...
    return {
        ...
        path: app.path,
        position: app.defaultPosition || getDefaultAppPosition(),
